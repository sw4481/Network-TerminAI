"""Output renderers for pyATS CLI envelope format.

Provides JSON, table, and YAML rendering options for the standardized envelope
structure. Mirrors the Meraki CLI renderer pattern.
"""
